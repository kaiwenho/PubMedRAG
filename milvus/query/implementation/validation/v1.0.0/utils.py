...
def match_llm_sentences_to_indices(llm_sentences: List[str], abstract_dict: Dict[str, any], edge_index: any, pmid: str, return_partial_matches: bool = True ) -> Tuple[List[int], Optional[Dict]]:
    """
...
def process_edge(edge_row: pd.Series, abstracts_dict: Dict[str, Dict], return_partial_matches: bool = True) -> Tuple[List[int], Optional[Dict]]:
    """
